...
VALUES (
  'feedback_form_v1',
  'Niche feedback form',
  'Initial form for capturing where an error occurred in Niche.',
  @created_by
);
...
INSERT INTO questions (question_key, created_by) VALUES ('supervisor_email', @created_by);
SET @q12_id := LAST_INSERT_ID();
INSERT INTO question_versions
  (question_id, version_number, prompt_text, response_type, is_required, help_text, is_active, created_by)
VALUES
  (@q12_id, 1, 'Supervisor email address', 'text', 1, 'Use the supervisor FIN/surname to look up their email address.', 1, @created_by);
SET @q12_v1_id := LAST_INSERT_ID();
...
(@form_version_id, @q12_v1_id, 11),
(@form_version_id, @q11_v1_id, 12);
...
VALUES
  ...
  (@form_version_id, @q4_v1_id, @q5_v1_id, 'equals', 'no', 'show', 1),
  (@form_version_id, @q4_v1_id, @q5_v1_id, 'not_equals', 'no', 'hide', 2);
